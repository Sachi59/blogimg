...
<html lang="en">
  <head>
    ...
    <title>ImageX Image and Fotos Upload & Management for your website</title>
 ...
 <div class="container-fluid" style="background-color: rgb(236, 240, 245);">
	<div class="row"  >
		...
		<img src="assets/img/Logo-pequeno.png" class="top10">
	<div class="container-fluid">
	<h1>Website Images Upload and Managment without database</h1>
	<h6>Very simple to install on your Back-End. This script works without database and let you manage all images inside the folder you choose. </h6>
		
		
	
 
		
		<p class="pull-right"><a href="https://codecanyon.net/user/litostop?ref=litostop" target="_blank" ><small class="label">This Script is exclusivly on Envato, Buy now!</small></a> </p>
  </div>
...
<input type="hidden" name="show_images_token" value="<?php echo $show_images_token;?>">
       ...
       <?php if(isset($_POST['selected_folder'])){?>
        ...
        <div class="col-sm-6 upload-container imagex-disabled">
			...
			<div class="dz-default dz-message "> <img src="assets/img/upload.png?a=1" class="img-responsive pull-center"><p><del><?php echo _('Drag and drop or click here to upload your  Jpg, Png or Gif Files');?></p></del></div>
			</form>
        </div>
